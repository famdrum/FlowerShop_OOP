...
public enum Flowers {
    ...
    ROSE(new RoseSpecification(25,"light",25,new Date(),"Netherlands","red")),WHITEROSE(new RoseSpecification(35,"light",50,new Date(),"Netherlands","white")),
    CHAMOMILE(new ChamomileSpecification(10,"good",19,new Date(),"Ukraine")),
